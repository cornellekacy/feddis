...
<!-- Mirrored from mannatstudio.com/html/logzee/new_color/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 29 Jan 2020 06:26:48 GMT -->
<head>
    <!-- xxx Basics xxx -->
    <meta charset="utf-8">
        ...
        <div class="row align-items-center">
          ...
          <div class="col-md-auto">
            ...
            <div class="d-inline-flex request-btn ml-2">
                <a class="btn-theme icon-left bg-orange no-shadow d-none d-lg-inline-block align-self-center" href="track.php" role="button" ><i class="icofont-page"></i> Track Package</a>
            </div>         
          </div>
        </div>
      </div>
      ...
      <div class="container text-nowrap bdr-nav px-0">
        <div class="d-flex mr-auto">
          <a class="navbar-brand rounded-bottom light-bg" href="index-2.html">
            <img src="images/logo_white2.png" alt="">
          </a> 
        </div>
