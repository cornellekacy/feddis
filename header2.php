...
<!-- Mirrored from mannatstudio.com/html/logzee/new_color/about-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 29 Jan 2020 06:30:16 GMT -->
<head>
    <!-- xxx Basics xxx -->
    <meta charset="utf-8">
    ...
    <title>Speedington Express - The Way To Ship</title>
    ...
    <!-- xxx Favicon xxx -->    
    <link rel="shortcut icon" type="image/x-icon" href="fed.png">
    ...
    <div class="top-bar-right d-flex align-items-center text-md-left">
      <div class="container">
        <div class="row align-items-center">
          <div class="col">
            <i class="icofont-google-map"></i>  254 Street Avenue, LA US
          </div>
    ...
    <nav class="navbar navbar-expand-lg bg-transparent">
      <div class="container text-nowrap">
        ...
        <div class="d-inline-flex request-btn order-lg-last col p-0"> 
          ...
          <a class="btn-theme icon-left bg-navy-blue no-shadow align-self-center" href="track.php" role="button" ><i class="icofont-page"></i> <span class="d-none d-sm-inline-block"> Track Package</span></a> 
          <!-- Toggle Button Start -->
