      ...
      <div id="rev_slider_1078_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.1">
        <ul>
          ...
          <div class="tp-caption tp-resizeme NotGeneric-Title" 
            ...
            >We Are Speedington Express</div>
            ...
            >We deliver your products on time with pure safety. We are here for your confort<br> We carry satisfaction with us</div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6">              
                  <div class="icon-box-6">
                    ...
                    <p>Get the best warehousing for your goods</p>
                ...
                <div class="col-12 col-md-6">              
                  <div class="icon-box-6">
                    ...
                    <p>Safety and quality service is our priority</p>
                    <a href="#" class="btn-arrow bg-navy-blue"><i class="icofont-swoosh-right"></i></a>
                  </div>              
                </div>
                <!-- Icon Box 6 -->
                ...
                <div class="col-12 col-md-6">              
                  <div class="icon-box-6">
                    ...
                    <p>We work in favor of the Environment, we care for it</p>
                    <a href="#" class="btn-arrow bg-navy-blue"><i class="icofont-swoosh-right"></i></a>
                  </div>              
                </div>
                <!-- Icon Box 6 -->
                ...
                <div class="col-12 col-md-6">              
                  <div class="icon-box-6">
                    ...
                    <p>We are punctual and we delivery in time we are here for you.</p>
                    <a href="#" class="btn-arrow bg-navy-blue"><i class="icofont-swoosh-right"></i></a>
                  </div>              
                </div>
                <!-- Icon Box 6 -->
        ...
        <div class="row">
          ...
          <div class="col-md-6 ml-auto why-choose wow fadeInRight" data-wow-duration="0" data-wow-delay="0.6s">
            ...
            <h1 class="heading-main text-left wow fadeInDown" data-wow-duration="0" data-wow-delay="0s">
              <span>ABOUT US</span>
              Welcome To Speedington Express Family
            </h1>
            <!-- Heading Main -->

           

            <p>We have the best services for our clinets, we are relatively cheap and affordable. Our customer support is the best and we make sure all our customer are satisfied. we bring just the best of services and joy to our clients</p>
                  ...
                  <div class="icon-box-3 mb-5 bg-sky-blue">
                    <div class="media">
                        ...
                        <div class="service-inner-content media-body">
                            ...
                            <p>We have a warehouse for all products we ship, no matter what you are shippig we cover you, don't spend money on wharehousing, we got you covered</p>
                        </div>
                    </div>
                  </div>              
                </div>
                  ...
                  <div class="icon-box-3 mb-5 bg-sky-blue">
                    <div class="media">
                        ...
                        <div class="service-inner-content media-body">
                            ...
                            <p>We are safe and the quality of our services is the best. Security for products arrival is our main priority</p>
                        </div>
                    </div>
                  </div>              
                </div>
                  ...
                  <div class="icon-box-3 bg-sky-blue">
                    <div class="media">
                        ...
                        <div class="service-inner-content media-body">
                            ...
                            <p>We use the latest technology so that we don't pollute our environment, our vessels are environment conducive</p>
                        </div>
                    </div>
                  </div>              
                </div>
...
">
                ...
                <div class="cbp-item photography">
                    ...
                    <a href="images/portfolio/fullwidth/img-10.jpg" class="cbp-caption cbp-lightbox" data-title="Lorem ipsum">
                        <div class="cbp-caption-defaultWrap">
                ...
                <div class="cbp-item business">
                    ...
                    <a href="images/portfolio/fullwidth/img-11.jpg" class="cbp-caption cbp-lightbox" data-title="Lorem ipsum">
                        <div class="cbp-caption-defaultWrap">
                  ...
                  <div class="client-testimonial bg-wave">
                    <div class="media">
                        ...
                        <div class="client-inner-content media-body">
                            <p>“ In our line of work, deadlines affect success. Our entire experience in the field is based on timelines. We can often place a fix on special opportunities if we know the truth and the timeline. Not only does Speedington Express deliver but they tell you what’s going on along the way. We definitely enjoy their level of service whether it be during the day or during the middle of the night. Speedington Express understands we are not making it up when we ask for a truck at some obscure dock at 4:00 am. Speedington Express is responsive, works through the available options and is determined that we are satisfied.” </p>
                            <footer class="blockquote-footer"><cite title="Source Title">Peterson Carl</cite></footer>
                        </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="item">
                  <div class="client-testimonial bg-wave">
                    <div class="media">
                        ...
                        <div class="client-inner-content media-body">
                            <p>“Speedington Express and my company have been working together since 2008. During this time, we have nearly doubled in size and so has the number of challenging shipping opportunities. Global Shippers Logistics provides exactly the service we need. They do a good job of understanding our requirements and providing solutions to meet those requirements. They are always available live, 24 hours a day. Their personnel make sure that our delivery needs, which can be complicated, are understood and met. Their attention to detail and follow up separates them from their competitors. I do not need to follow up to check on our shipments. Instead Speedington Express sends updates and delivery results. In short they provide peace of mind. Speedington Express stands out in their niche of the freight business </p>
                            <footer class="blockquote-footer"><cite title="Source Title">Sam Junior</cite></footer>
                        </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="item">
                  <div class="client-testimonial bg-wave">
                    <div class="media">
                        ...
                        <div class="client-inner-content media-body">
                            <p> I have had the pleasure of working with Speedington Express since finding them while employed at a previous exhibit house. Their entire staff has always proved to be valuable allies in the daily transportation challenges related to the tradeshow business. Speedington Express provides excellent customer service and always works with our best interests at the forefront in whatever type of move they’re doing for us at the time.” </p>
                            <footer class="blockquote-footer"><cite title="Source Title">John Gerry</cite></footer>
                        </div>
                    </div>
                  </div>
                </div>
